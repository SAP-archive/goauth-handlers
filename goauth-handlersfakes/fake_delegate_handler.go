...
type FakeDelegateHandler struct {
...
func (fake *FakeDelegateHandler) ServeHTTP(arg1 http.ResponseWriter, arg2 *http.Request) {
...
func (fake *FakeDelegateHandler) ServeHTTPCallCount() int {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
	return len(fake.serveHTTPArgsForCall)
}

func (fake *FakeDelegateHandler) ServeHTTPCalls(stub func(http.ResponseWriter, *http.Request)) {
	fake.serveHTTPMutex.Lock()
	defer fake.serveHTTPMutex.Unlock()
	fake.ServeHTTPStub = stub
}

func (fake *FakeDelegateHandler) ServeHTTPArgsForCall(i int) (http.ResponseWriter, *http.Request) {
	fake.serveHTTPMutex.RLock()
	defer fake.serveHTTPMutex.RUnlock()
...
func (fake *FakeDelegateHandler) Invocations() map[string][][]interface{} {
...
func (fake *FakeDelegateHandler) recordInvocation(key string, args []interface{}) {
...
var _ goauth_handlers.DelegateHandler = new(FakeDelegateHandler)
